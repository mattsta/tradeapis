...
# Decimal subclasses need to overwrite __repr__ because
# Decimal is a python built-in C module, so it doesn't adapt
...
class DecimalPrice(NamedDecimal): ...
class DecimalPercent(NamedDecimal): ...
class DecimalShares(NamedDecimal): ...
